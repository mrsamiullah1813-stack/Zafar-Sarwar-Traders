...
export const FloatingWhatsApp: React.FC<FloatingWhatsAppProps> = ({ config }) => {
  ...
  // Target phone number: +92 310 8002863
  const targetNumber = "923108002863";

  const handleSend = () => {
    const defaultText = `Hello Zafar Sarwar Traders, I am interested in your luxury sanitaryware, plumbing, and building materials.`;
  ...
  const handleDirectClick = () => {
    const text = encodeURIComponent(`Hello Zafar Sarwar Traders, I am inquiring about your products and wholesale availability.`);
  ...
  return (
    <div className="fixed bottom-6 left-6 z-50 flex flex-col items-start">
      ...
      {open && (
        <div className="mb-4 w-80 sm:w-88 rounded-3xl bg-slate-900 border border-slate-800 shadow-2xl p-5 overflow-hidden animate-fadeIn">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-emerald-400 text-[10px] font-semibold flex items-center gap-1">
                  <span>+92 310 8002863</span> • <span>Online</span>
                </p>
              </div>
            </div>
          ...
          <div className="my-3 p-3.5 rounded-2xl bg-slate-950/90 border border-slate-800 text-slate-300 text-xs font-light space-y-1">
            <p className="font-semibold text-blue-300">Welcome to Zafar Sarwar Traders!</p>
          ...
          <div className="space-y-2">
            ...
            >
              ...
              <span>Start WhatsApp Chat (+92 310 8002863)</span>
            </button>
          </div>
        </div>
      )}
      ...
      <button
        ...
        title="Chat on WhatsApp (+92 310 8002863)"
      >
