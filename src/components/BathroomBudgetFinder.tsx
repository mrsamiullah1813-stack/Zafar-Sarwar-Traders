            ...
            <div className="space-y-2 pt-2 border-t border-slate-800">
              ...
              <div className="grid grid-cols-2 gap-2">
                <button
                  ...
                  className="py-2.5 px-3 rounded-lg bg-gradient-to-b from-blue-600 to-blue-700 hover:from-blue-500 hover:to-blue-600 active:from-blue-700 active:to-blue-800 text-white font-semibold text-xs flex items-center justify-center gap-1.5 transition-all duration-200 shadow-sm hover:shadow-md hover:shadow-blue-600/20 border border-blue-500/40 active:scale-[0.98] cursor-pointer disabled:opacity-60 disabled:cursor-not-allowed"
                >
